...
export default function CompanyStatus() {
  ...
  const handleEdit = () => {
    history.push("/app/company/" + company + "/edit");
  };
  ...
  return (
    <div className={classes.root}>
      <Stepper activeStep={activeStep} connector={<ColorlibConnector />} orientation="vertical">
        <Step active={true}>
          <StepLabel StepIconComponent={ColorlibStepIcon}>Create Company</StepLabel>
          <StyledStepContent>
        ...
        <Step active={true}>
          <StepLabel StepIconComponent={ColorlibStepIcon}>Receive Company</StepLabel>
          <StyledStepContent>
